    ...
    <div className="bl-root" onClick={()=>openMenu&&setOpenMenu(null)}>
      ...
      <style>{`
        *{box-sizing:border-box;}
        ...
        .bl-nptab-on{color:#fff !important;background:#4772b3 !important;border-left-color:#76a8e0 !important;}
        ...
        .bl-shade-btn,.bl-vp-shade{padding:2px 7px;background:rgba(30,30,30,0.8);border:1px solid #555;border-radius:3px;color:#aaa;cursor:pointer;font-size:10px;transition:all 0.15s;}
        .bl-shade-btn:hover,.bl-vp-shade:hover{background:#555;color:#fff;}
        .bl-shade-active,.bl-vp-shade-on{background:#4772b3 !important;border-color:#4772b3 !important;color:#fff !important;}
